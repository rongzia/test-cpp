...
extern const char *clientNolockClose(char *argin, u32 inlen, u32 outlen);
...
static int remoteUnfetch(sqlite3_file *fd, i64 iOff, void *p) {
    ...
    DebugClient(sprintf(debugStr, "---end remoteUnfetch:\n"), debugStr);
    return rc;
}

//static int remoteNolockClose(sqlite3_file *fd) {
//    DebugClient(sprintf(debugStr, "---start remoteNolockClose:\n"), debugStr);
//    char argInChar[sizeof(ArgInNolockClose)];
//    memset(argInChar, 0, sizeof(ArgInNolockClose));
//    int rc = SQLITE_OK;
//
//    nolockCloseConvertArgInToChar(fd, argInChar);
//    const char *argOutChar = clientNolockClose(argInChar, sizeof(), sizeof());
//    nolockCloseConvertCharToReturn(argOutChar, fd, &rc);
//    DebugClient(sprintf(debugStr, "---end remoteUnfetch:\n"), debugStr);
//    return rc;
//}
...
//void Test_NolockClose(() {
//    printf("---remoteNolockClose(:\n");
//    int rc = remote_sqlite3_os_init();
//
//    unixFile fi;
//    int outFlag = 2;
...
//    printf("   outFlag = %d\n", outFlag);
//
//    rc = remoteNolockClose((sqlite3_file *) &fi);
//
//    printf("   f.h = %d\n", fi.h);
//    printf("   rc = %d\n", rc);
//}
